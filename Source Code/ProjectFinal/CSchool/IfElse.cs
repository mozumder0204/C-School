...
namespace CSchool
{
    public partial class IfElse : UserControl
    {
        int s = 1;
        public IfElse()
        {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (GPanel.Location.X == 460)
            {
                timer1.Stop();
                GPanel.Location = new Point(GPanel.Location.X - 430, GPanel.Location.Y + 20);
                ...
                if (GPanel.Location.Y == 150)
                {
                    GPanel.Location = new Point(30,50);
